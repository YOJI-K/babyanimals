...
const SPECIES_INFO = {
  'ゾウ': {
    iucn: 'EN（絶滅危惧種・アジアゾウ）',
    desc: 'ゾウは陸上で最大の哺乳類で、長い鼻で器用に物をつかみ、仲間と協力し合う高い知能と社会性をもちます。赤ちゃんは体重約100kgで生まれ、群れのメスたちに見守られて育ちます。動物園で見られるアジアゾウはIUCNレッドリストで「絶滅危惧種（EN）」に指定され、生息地の減少や密猟で数を減らしています。飼育下の繁殖は種の保全と環境教育に大きな役割を果たしています。',
  },
  'ヤクシマザル': {
    iucn: 'LC（軽度懸念）',
