...
const SPECIES_INFO = {
  ...
  'カピバラ': {
    iucn: 'LC（軽度懸念）',
    desc: 'カピバラは南米の川辺や湿地で群れをつくる世界最大のげっ歯類です。水かきのある足で泳ぎが得意で、危険を感じると水中へ逃げ込みます。赤ちゃんは生まれてすぐ歩き、群れのどの母親からも乳をもらえる共同保育で育つのが特徴。IUCNレッドリストでは「軽度懸念（LC）」で個体数は安定していますが、湿地の開発や狩猟は続いています。温泉に浸かる姿でおなじみですが、群れの中で赤ちゃんが育つ様子はこの動物の社会性を知る手がかりになります。',
  },
  'マレーバク': {
    iucn: 'EN（絶滅危惧種）',
    desc: '白と黒のツートンカラーが目を引くマレーバクは、東南アジアの熱帯雨林にすむバクの仲間で、アジアに現存する唯一の種です。赤ちゃんはウリ坊のような白い縞とまだら模様をまとい、下草に紛れて身を守りながら半年ほどかけて親と同じ体色に変わります。IUCNレッドリストでは「絶滅危惧種（EN）」とされ、アブラヤシ農園の拡大による森林伐採が最大の脅威。国内でも飼育園は限られ、模様が変わる前の姿に会える期間はごくわずかです。',
  },
  'チーター': {
    iucn: 'VU（危急種）',
    desc: '時速100キロを超える加速で獲物を追うチーターは、陸上最速のハンターとして知られます。速さに特化した細い体はほかの肉食獣に獲物を奪われやすく、母親は単独で子を育てます。赤ちゃんは背中に銀灰色のたてがみをもち、天敵から身を隠すのに役立つと考えられています。IUCNレッドリストでは「危急種（VU）」。生息地の分断やペット目的の密輸が深刻で、飼育下での繁殖は個体群を守る取り組みのひとつです。',
  },
  'オグロプレーリードッグ': {
    iucn: 'LC（軽度懸念）',
    desc: '北米の草原に地下トンネルの「タウン」を築いて暮らすのがオグロプレーリードッグです。仲間と口を合わせる挨拶や、天敵の種類を鳴き分ける警戒声など、コミュニケーションの豊かさで知られます。赤ちゃんは巣穴の中で生まれ、生後6週ほどで地上に姿を見せはじめます。IUCNレッドリストでは「軽度懸念（LC）」ですが、かつて害獣として大規模に駆除され、生息数は往時のわずかな割合まで落ち込みました。草原生態系の要となる動物です。',
  },
  'スーチョワンバーラル': {
    iucn: 'LC（軽度懸念）',
    desc: 'スーチョワンバーラルは中国・四川省周辺の高山帯にすむバーラル（ブルーシープ）の一亜種で、青みを帯びた灰褐色の毛が岩肌に溶け込みます。切り立った岩場を駆け上がる跳躍力は圧巻。赤ちゃんは生後まもなく険しい斜面を歩きはじめ、母子で群れに合流します。母種のバーラルはIUCNレッドリストで「軽度懸念（LC）」ですが、家畜との牧草競合や密猟が指摘されています。国内での飼育例は少なく、間近で見られる機会は貴重です。',
  },
  'プーズー': {
    iucn: 'NT（準絶滅危惧）',
    desc: '体高40センチほどしかないプーズーは、南米チリ・アルゼンチンの温帯林にすむ世界最小級のシカです。まっすぐな短い角をもち、警戒心が強く、茂みの奥で単独に近い暮らしを送ります。赤ちゃんは白い斑点をもち、生後まもなく母親について歩けるようになります。IUCNレッドリストでは「準絶滅危惧（NT）」。森林伐採や放し飼いのイヌによる捕食が脅威です。手のひらに乗る大きさで生まれる姿は、シカの多様さを教えてくれます。',
  },
  'オオツノヒツジ': {
    iucn: 'LC（軽度懸念）',
    desc: 'オオツノヒツジの雄がもつ渦を巻いた巨大な角は、重さが体重の1割に達することもあります。繁殖期には雄同士が角を打ち合わせ、その音は遠くまで響きます。赤ちゃんは断崖に近い安全な場所で生まれ、数日で母親と一緒に岩場を移動できるようになります。IUCNレッドリストでは「軽度懸念（LC）」ですが、家畜由来の感染症や生息地の分断で地域個体群が減った歴史があります。角が育つ過程を年ごとに追えるのが飼育下の魅力です。',
  },
  'オオアリクイ': {
    iucn: 'VU（危急種）',
    desc: 'オオアリクイは60センチにもなる細長い舌でアリやシロアリをすくい取る、南米の草原と森林にすむ動物です。歯はなく、鋭い前足の爪で蟻塚を壊します。赤ちゃんは母親の背中に乗って運ばれ、体の縞模様が母親と重なることで輪郭がぼやけ、外敵から見つかりにくくなります。IUCNレッドリストでは「危急種（VU）」で、草原の火災や交通事故が主な脅威。背中の親子が一体に見える不思議な姿は、この動物ならではの見どころです。',
  },
  'ツシマヤマネコ': {
    iucn: 'LC（軽度懸念）',
    desc: '長崎県の対馬だけに生息するツシマヤマネコは、耳の裏の白い斑点と胴の縞模様が目印の野生ネコです。夜行性で、ネズミや鳥、カエルまで幅広く食べます。赤ちゃんは樹洞などで生まれ、母親から狩りを教わって独り立ちします。母種のベンガルヤマネコはIUCNレッドリストで「軽度懸念（LC）」ですが、対馬の個体群は100頭前後まで減り、国内では国内希少野生動植物種に指定。動物園の繁殖は野生復帰を見据えた取り組みです。',
  },
  'ヤクシカ': {
    iucn: 'LC（軽度懸念）',
    desc: '屋久島の照葉樹林に暮らすヤクシカは、本州のニホンジカより一回り小さい固有亜種です。世界自然遺産の森で落ち葉や木の実を食べながら、島の植生と深く関わって生きています。赤ちゃんは白い斑点をまとい、下草の中でじっと身を潜めて母親の帰りを待ちます。母種のニホンジカはIUCNレッドリストで「軽度懸念（LC）」。島では増えすぎによる植生への影響が課題で、人と野生動物の共存のあり方を考えるきっかけになります。',
  },
  'マゼランペンギン': {
    iucn: 'LC（軽度懸念）',
    desc: 'マゼランペンギンは南米大陸南部の海岸で、地面に穴を掘って巣をつくるペンギンです。胸元の黒い二本線が、近縁のフンボルトペンギンとの見分けどころ。ヒナは灰色の綿羽に包まれ、両親が交代で海へ通って運ぶ魚で育ちます。IUCNレッドリストでは「軽度懸念（LC）」ですが、漁業との餌の競合や油濁被害で個体数は減少傾向。巣穴を掘る行動は飼育下でも見られ、海鳥がどう子育てをするのかを間近で観察できます。',
  },
  'タンチョウ': {
    iucn: 'VU（危急種）',
    desc: '頭頂の赤い肌から名がついたタンチョウは、翼を広げると2メートルを超える大型のツルです。北海道東部の湿原には周年とどまる個体群があり、雪原で向かい合って跳ねる求愛ダンスは冬の風物詩。ヒナは茶色の羽毛で生まれ、両親に守られながら1年近く一緒に過ごします。IUCNレッドリストでは「危急種（VU）」で、2021年に絶滅危惧種から引き下げられました。国内では特別天然記念物ですが、湿原の減少は今も続いています。',
  },
};
