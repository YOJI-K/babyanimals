...
export const ZOOS = [
  ...
  },
  {
    ...
    nearest_station: 'JR帯広駅前9番乗り場から十勝バス約18分「動物園前」下車、徒歩約300m\nJR帯広駅前2番乗り場から拓殖バス約16分「緑ヶ丘6丁目美術館入り口」下車、徒歩約600m',
    hours: '夏期 4/29〜9/30 9:00〜16:30／10/1〜11/3 9:30〜16:00\n冬期 12/5〜2月末の土日祝 11:00〜14:00',
    closed_days: '夏期・冬期の開園期間外（11/4〜12/4、3/1〜4/28）、年末年始（12/29〜1/3）',
    fees: '大人 420円／高校生 210円／65歳以上 210円／中学生以下 無料',
    description: 'エゾシカ・エゾリス・キタキツネなど北海道の在来種展示に力を入れる市立動物園。ホッキョクグマやアムールトラ、アミメキリンも飼育する。冬期は土日祝のみ11時〜14時の短時間開園となる。',
    official_url: 'https://www.city.obihiro.hokkaido.jp/zoo/',
    asoview_url: null,
    hero_emoji: '🐻‍❄️',
  },
  // ── 東北 ─────────────────────────────────────────────────────────────
  ...
  },
  {
    ...
    nearest_station: '小湊鐵道「高滝駅」から予約制無料送迎バス約10分（要事前予約・駅にタクシー常駐なし）\n圏央道「市原鶴舞IC」から車で約5分',
    hours: '10:00〜16:00（最終入園 15:30）',
    closed_days: '不定休（春夏休み・祝日・年末年始は営業）※公式営業カレンダーで要確認',
    fees: '大人（中学生以上）2,400円／小人（3才〜小学生）900円／シニア（65歳以上）2,000円',
    description: '国内最多となる9頭のゾウが暮らす私設動物園。サッカーやダンスを披露する「ぞうさんのパフォーマンスタイム」やぞうさんライドが名物で、カピバラやカバなど約70種の動物におやつをあげられる。',
    official_url: 'https://www.zounokuni.com/',
    asoview_url: null,
    hero_emoji: '🐘',
  },
  // ── 東京（追加）・神奈川 ────────────────────────────────────
  ...
  {
    slug: 'nihondaira',
    // TODO: zoos テーブルに '日本平動物園' の重複レコードが残存（赤ちゃん1頭）。統合は要オーナー対応
    db_name: '静岡市立日本平動物園',
    name: '静岡市立日本平動物園',
    prefecture: '静岡県',
    city: '静岡市',
  ...
  // ── 長野 ────────────────────────────────────────────────────
  {
    ...
    prefecture: '長野県',
    city: '長野市',
    address: '〒380-0802 長野県長野市上松2-1-19',
    nearest_station: '長野電鉄「善光寺下」駅から徒歩約20分\nJR「長野駅」から長野電鉄バス浅川西条線 約15分「動物園下」下車、徒歩約3分',
    hours: '3/1〜10/31 9:00〜17:00／11/1〜2月末日 9:00〜16:30',
    closed_days: '3/1〜11/30 休園日なし／12/1〜2月末日 毎週月曜（休日の場合は翌日）・12/29〜12/31',
    fees: '無料（団体は要予約）',
    description: '善光寺に隣接する城山公園内にある入園無料の都市型動物園。カリフォルニアアシカのお食事タイムが人気で、フンボルトペンギンやケープハイラックスなど哺乳類12種・鳥類22種を飼育。大小の遊具も備える。',
    official_url: 'https://johyama.com/',
    asoview_url: null,
    hero_emoji: '🦭',
  },
  // ── 愛知・石川・富山 ─────────────────────────────────────────
  ...
  },
  {
    ...
    prefecture: '兵庫県',
    city: '姫路市',
    address: '〒679-2121 兵庫県姫路市豊富町神谷1434',
    nearest_station: 'JR・山陽電鉄「姫路駅」北口から神姫バス「姫路セントラルパーク」行き（大人 590円／小児 300円）',
    hours: '10:00〜17:00（時期により 10:00〜16:30 / 10:00〜18:00）※公式営業カレンダーで要確認',
    closed_days: '主に水曜日（時期により火曜・水曜の連休あり）※公式営業カレンダーで要確認',
    fees: '入園券 大人（中学生以上）4,200〜4,600円／小学生 2,400〜2,800円／幼児（3歳〜小学生未満）1,300〜1,500円（入園日により変動）',
    description: 'マイカーやサファリライドで巡るドライブスルーサファリを備えた日本最大級のサファリパーク。ホワイトライオンやホワイトタイガーに会えるウォーキングサファリのほか、遊園地・プール・アイススケートも併設。',
    official_url: 'https://www.central-park.co.jp/',
    asoview_url: null,
    hero_emoji: '🐅',
  },
  {
  ...
  },
  {
    ...
    prefecture: '山口県',
    city: '周南市',
    address: '〒745-0874 山口県周南市大字徳山5846',
    nearest_station: 'JR「徳山駅」みゆき口（北口）から徒歩約20分\nバスターミナル⑥・⑦のりばから約10分「動物園文化会館入口」下車',
    hours: '夏時間 3/1〜10/19 9:00〜17:00／冬時間 10/20〜2月末日 9:00〜16:30（入園は閉園30分前まで）',
    closed_days: '毎週火曜日（祝日の場合は翌日）・年末（12/29〜12/31）',
    fees: '大人 600円／小・中・高校生 300円／未就学児 無料／年間パスポート 1,500円',
    description: 'スリランカゾウやマレーグマが暮らすアジアの熱帯雨林ゾーン、身近な動物とふれあえる「周南の里ふれあいゾーン るんちゃ♪るんちゃ」、野鳥観察所を併設する自然学習館ねいちゃるが見どころの市立動物園。',
    // TODO: zoos.website が誤ドメイン（tokuyamazoo.jp）。要オーナー修正
    official_url: 'https://www.tokuyama-zoo.jp/',
    asoview_url: null,
    hero_emoji: '🦦',
  },
  {
